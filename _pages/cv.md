...
Incoming direct Ph.D. student at Zhejiang University working on AI for Science, domain LLMs, multi-agent systems, RAG, and scientific computing.

- Email: [liucunyu@westlake.edu.cn](mailto:liucunyu@westlake.edu.cn)
- GitHub: [github.com/Cunyu-Liu](https://github.com/Cunyu-Liu)
- CSDN: [blog.csdn.net/weixin_74152658](https://blog.csdn.net/weixin_74152658?type=blog)

Education
======

* Direct Ph.D. student, College of Artificial Intelligence, Zhejiang University, 2026.09 - 2031.06 (expected). Advisor: Prof. Tingjun Hou.
* B.Eng. in Software Engineering, School of Software, North University of China, 2022.09 - 2026.06 (expected). GPA 3.96/5.00, ranked 1/200 in major and overall evaluation.
...
* Trained entropy models and BLT-style global models for RNA sequence modeling with enhanced block-level positional encoding.
...
* Implemented asynchronous LLM call chains with Coze Bot API, Aily, Fornax GPT, multimodal prompts, Redis queues, Spring Boot pipelines, CompletableFuture, CountDownLatch, and scheduled data-quality tasks.
* Developed RAG-based defect automation coverage review with BBQ/BBC dual recall, Viking DB, Milvus, MCP SDK, JWT authentication, multimodal information completeness checks, confidence scoring, and Feishu Bitable output.
* Built Bits/BOSS testing tools, BOSS CLI, and OpenClaw Skill Gateway for tenant creation, asset unsubscribe, quota query/reporting, mock time, and natural-language Skill invocation.
...
* Integrated IoT monitoring, AI-assisted recognition, and data visualization.
* Received software copyright and national/provincial awards.

Skills
======

* AI and modeling: SFT, QLoRA, DoRA, 4-bit quantization, LangGraph, Agent workflows, RAG, Milvus, Elasticsearch, RRF, knowledge graphs, LLM-as-a-Judge, Transformer, LightGBM, XGBoost.
* Engineering: Python, Java, C, R, PyTorch, Hugging Face, Llama Factory, FastAPI, Flask, React, Vue, TypeScript, Node.js, Puppeteer, MCP SDK, CI/CD, automated testing.
...
* Outstanding League Member, North University of China.
